...
import * as import9 from 'angular2-moment/moment.module';
...
import * as import56 from '../pages/games/games.ngfactory';
import * as import57 from '../pages/rules/rules.ngfactory';
import * as import58 from '../pages/ranking/ranking.ngfactory';
import * as import59 from '../pages/tabs/tabs.ngfactory';
import * as import60 from '../pages/games/game-insert.ngfactory';
...
class AppModuleInjector extends import0.NgModuleInjector<import1.AppModule> {
  ...
  _MomentModule_8:import9.MomentModule;
  ...
  constructor(parent:import46.Injector) {
    super(parent,[
      ...
      import55.MyAppNgFactory,
      import56.GamesPageNgFactory,
      import56.GamesDetailNgFactory,
      import57.RulesPageNgFactory,
      import58.RankingPageNgFactory,
      import59.TabsPageNgFactory,
      import60.GameInsertNgFactory,
      import60.GamePreviewNgFactory,
      import49.IonicAppNgFactory
    ]
    ,[import49.IonicAppNgFactory]);
  }
  ...
  get _APP_ID_30():any {
    if ((this.__APP_ID_30 == (null as any))) { (this.__APP_ID_30 = import61._appIdRandomProviderFactory()); }
  ...
  get _EVENT_MANAGER_PLUGINS_33():any[] {
    if ((this.__EVENT_MANAGER_PLUGINS_33 == (null as any))) { (this.__EVENT_MANAGER_PLUGINS_33 = [
      ...
      new import64.HammerGesturesPlugin(this._HAMMER_GESTURE_CONFIG_32)
    ]
    ); }
    return this.__EVENT_MANAGER_PLUGINS_33;
  }
  get _EventManager_34():import17.EventManager {
    if ((this.__EventManager_34 == (null as any))) { (this.__EventManager_34 = new import17.EventManager(this._EVENT_MANAGER_PLUGINS_33,this.parent.get(import65.NgZone))); }
  ...
  get _RootRenderer_38():any {
    if ((this.__RootRenderer_38 == (null as any))) { (this.__RootRenderer_38 = import66._createConditionalRootRenderer(this._DomRootRenderer_37,this.parent.get(import66.NgProbeToken,(null as any)))); }
  ...
  get _AppRootToken_54():any {
    if ((this.__AppRootToken_54 == (null as any))) { (this.__AppRootToken_54 = import67.MyApp); }
  ...
  get _Keyboard_62():import35.Keyboard {
    if ((this.__Keyboard_62 == (null as any))) { (this.__Keyboard_62 = new import35.Keyboard(this._Config_22,this._Form_59,this.parent.get(import65.NgZone))); }
  ...
  get _LocationStrategy_64():any {
    if ((this.__LocationStrategy_64 == (null as any))) { (this.__LocationStrategy_64 = import8.provideLocationStrategy(this.parent.get(import68.PlatformLocation),this.parent.get(import69.APP_BASE_HREF,(null as any)),this._Config_22)); }
  ...
  get _TapClick_70():import42.TapClick {
    if ((this.__TapClick_70 == (null as any))) { (this.__TapClick_70 = new import42.TapClick(this._Config_22,this._App_23,this.parent.get(import65.NgZone))); }
  ...
  get _UrlSerializer_74():any {
    if ((this.__UrlSerializer_74 == (null as any))) { (this.__UrlSerializer_74 = import70.setupUrlSerializer(this._DeepLinkConfigToken_55)); }
    return this.__UrlSerializer_74;
  }
  get _DeepLinker_75():any {
    if ((this.__DeepLinker_75 == (null as any))) { (this.__DeepLinker_75 = import71.setupDeepLinker(this._App_23,this._UrlSerializer_74,this._Location_65)); }
    return this.__DeepLinker_75;
  }
  get _TRANSLATIONS_FORMAT_76():any {
    if ((this.__TRANSLATIONS_FORMAT_76 == (null as any))) { (this.__TRANSLATIONS_FORMAT_76 = (null as any)); }
    return this.__TRANSLATIONS_FORMAT_76;
  }
  createInternal():import1.AppModule {
    ...
    this._MomentModule_8 = new import9.MomentModule();
    ...
    this._QueryParams_15 = import72.setupQueryParams(this._UrlToken_14);
    this._PlatformConfigToken_16 = import73.providePlatformConfigs();
    ...
    this._Platform_21 = import74.setupPlatform(this._PlatformConfigToken_16,this._QueryParams_15,this._UserAgentToken_17,this._NavigatorPlatformToken_18,this._DocumentDirToken_19,this._DocLangToken_20,this.parent.get(import65.NgZone));
    this._Config_22 = import75.setupConfig(this._ConfigToken_13,this._QueryParams_15,this._Platform_21);
    this._App_23 = new import11.App(this._Config_22,this._Platform_21);
    this._APP_INITIALIZER_24 = [
      import76.registerModeConfigs(this._Config_22),
      import77.registerTransitions(this._Config_22),
      import31.setupProvideEvents(this._Platform_21),
      import42.setupTapClick(this._Config_22,this._App_23,this.parent.get(import65.NgZone))
    ]
    ;
    this._ApplicationInitStatus_25 = new import12.ApplicationInitStatus(this._APP_INITIALIZER_24);
    this._Testability_26 = new import13.Testability(this.parent.get(import65.NgZone));
    this._ApplicationRef__27 = new import14.ApplicationRef_(this.parent.get(import65.NgZone),this.parent.get(import78.Console),this,this._ErrorHandler_12,this,this._ApplicationInitStatus_25,this.parent.get(import13.TestabilityRegistry,(null as any)),this._Testability_26);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import9.MomentModule)) { return this._MomentModule_8; }
    if ((token === import1.AppModule)) { return this._AppModule_9; }
    if ((token === import79.LOCALE_ID)) { return this._LOCALE_ID_10; }
    if ((token === import10.NgLocalization)) { return this._NgLocalization_11; }
    if ((token === import80.ErrorHandler)) { return this._ErrorHandler_12; }
    if ((token === import75.ConfigToken)) { return this._ConfigToken_13; }
    if ((token === import72.UrlToken)) { return this._UrlToken_14; }
    if ((token === import72.QueryParams)) { return this._QueryParams_15; }
    if ((token === import73.PlatformConfigToken)) { return this._PlatformConfigToken_16; }
    if ((token === import74.UserAgentToken)) { return this._UserAgentToken_17; }
    if ((token === import74.NavigatorPlatformToken)) { return this._NavigatorPlatformToken_18; }
    if ((token === import74.DocumentDirToken)) { return this._DocumentDirToken_19; }
    if ((token === import74.DocLangToken)) { return this._DocLangToken_20; }
    if ((token === import74.Platform)) { return this._Platform_21; }
    if ((token === import75.Config)) { return this._Config_22; }
    ...
    if ((token === import61.APP_ID)) { return this._APP_ID_30; }
    if ((token === import81.DOCUMENT)) { return this._DOCUMENT_31; }
    if ((token === import64.HAMMER_GESTURE_CONFIG)) { return this._HAMMER_GESTURE_CONFIG_32; }
    ...
    if ((token === import82.AnimationDriver)) { return this._AnimationDriver_36; }
    if ((token === import19.DomRootRenderer)) { return this._DomRootRenderer_37; }
    if ((token === import83.RootRenderer)) { return this._RootRenderer_38; }
    if ((token === import20.DomSanitizer)) { return this._DomSanitizer_39; }
    if ((token === import84.Sanitizer)) { return this._Sanitizer_40; }
    if ((token === import21.ViewUtils)) { return this._ViewUtils_41; }
    if ((token === import85.IterableDiffers)) { return this._IterableDiffers_42; }
    if ((token === import86.KeyValueDiffers)) { return this._KeyValueDiffers_43; }
    ...
    if ((token === import89.AppRootToken)) { return this._AppRootToken_54; }
    if ((token === import70.DeepLinkConfigToken)) { return this._DeepLinkConfigToken_55; }
    ...
    if ((token === import69.LocationStrategy)) { return this._LocationStrategy_64; }
    ...
    if ((token === import70.UrlSerializer)) { return this._UrlSerializer_74; }
    if ((token === import71.DeepLinker)) { return this._DeepLinker_75; }
    if ((token === import90.TRANSLATIONS_FORMAT)) { return this._TRANSLATIONS_FORMAT_76; }
